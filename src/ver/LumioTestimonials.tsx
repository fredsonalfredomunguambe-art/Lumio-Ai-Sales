  ...
  const testimonials = [
    {
      ...
      quote:
        "Lumio made our marketing so much easier. We went from struggling to see results to actually growing our business.",
    },
    {
      name: "Jason Carter",
      role: "Founder",
      ...
      quote:
        "We were spending money on ads without really knowing if they worked. Lumio showed us exactly where our customers were coming from. It's not perfect, but it's way better than what we had.",
    },
    {
      name: "Karen Davis",
      ...
      quote:
        "I was skeptical at first, but the reporting is actually useful. We can see which campaigns are performing and adjust quickly. It's saved me a lot of time on manual tracking.",
    },
    {
      name: "Megan Wilson",
      role: "Growth Manager",
      ...
      quote:
        "We found new customer groups we never knew existed. Lumio helped us grow our business in ways we didn't expect.",
    },
    {
      name: "David Kim",
      ...
      quote:
        "Managing multiple campaigns used to be a nightmare. Now everything is in one place and works together perfectly.",
    },
    {
      name: "Malik Johnson",
      ...
      quote:
        "Lumio changed how we think about marketing. It's not just a tool, it's like having a smart marketing partner.",
    },
    {
      name: "Ryan Mitchell",
      ...
      quote:
        "As a young professional, Lumio helped me understand marketing in a way that actually makes sense. Our campaigns are now much more effective.",
    },
    {
      ...
      quote:
        "After trying dozens of marketing tools, most are just fancy dashboards with no real insights. Lumio actually helps us understand our audience better. It's refreshing to find something that works.",
    },
    {
      name: "Emma Thompson",
      ...
      quote:
        "Marvin is absolutely brilliant! It's like having a marketing genius who never sleeps. He spots trends I completely miss and gives me ideas that actually work. My team thinks I'm a genius now, but it's all Marvin!",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 font-outfit">
            Companies that <span className="text-blue-600">Grow</span> with
            Lumio
          </h2>
          <p className="text-gray-600 font-outfit">
            See how real companies are transforming their marketing
          </p>
        </div>
        ...
        >
          <div className="bg-blue-600 text-white rounded-xl p-8">
            ...
            <p className="text-blue-100 mb-6 font-outfit">
              Join hundreds of companies already growing with Lumio
            </p>
