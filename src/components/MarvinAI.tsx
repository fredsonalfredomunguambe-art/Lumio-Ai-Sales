          ...
          <div className="relative z-10 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-base text-gray-600 font-outfit font-medium max-w-xl mx-auto leading-relaxed">
                Your AI sales development representative that works 24/7 to
                capture, engage, and convert leads while you sleep
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-gray-900 font-outfit leading-tight">
                    Your Always-On{" "}
                    <span className="text-blue-600">Sales Partner</span>
                  </h3>
                  <p className="text-base text-gray-600 font-outfit leading-relaxed">
                    Unlike generic automation tools, Marvin continuously learns
                    from your inputs, adapts to your goals, and evolves with
                    your customers — ensuring every interaction feels authentic,
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-600 font-outfit">
                      ...
                      - Identifies your hottest prospects automatically
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-600 font-outfit">
                      ...
                      - Context-aware conversations that convert
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
                ...
                <div className="pt-2">
                  <Link
                    href="/sign-up"
                    className="group relative w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 font-outfit text-base overflow-hidden"
                  >
