    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          >
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-zinc-50 font-outfit mb-1">
                Integrations
              </h1>
            ...
            <div className="flex items-center space-x-2">
              <button className="flex items-center space-x-2 px-3 py-2 border border-gray-200 dark:border-zinc-800 rounded-lg text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:text-zinc-50 hover:bg-gray-50 transition-all text-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {/* Filters and Search */}
        <motion.div
          className="bg-white dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-zinc-800 p-4 mb-6"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-3 lg:space-y-0">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 dark:border-zinc-800 text-gray-900 dark:text-zinc-50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all font-inter"
              />
            </div>
              ...
              <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg">
                {filters.map((filter) => (
                  <button
                    ...
                    className={`px-2 py-1 rounded-md text-xs font-medium transition-all font-outfit ${
                      activeFilter === filter.id
                        ? "bg-white dark:bg-zinc-900 text-blue-600 shadow-sm"
                        : "text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:text-zinc-50"
                    }`}
                  >
                    {filter.name}
                    {filter.count > 0 && (
                      <span className="ml-1 text-xs bg-gray-200 text-gray-600 dark:text-zinc-400 px-1.5 py-0.5 rounded-full">
                        {filter.count}
                      </span>
                    )}
                  </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          {[
            ...
            <motion.div
              key={stat.name}
              className="bg-white dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-zinc-800 p-4 shadow-sm hover:shadow-md transition-all duration-300"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-zinc-50 font-outfit mb-1">
                {stat.value}
              </h3>
              <p className="text-gray-600 dark:text-zinc-400 font-inter text-sm">
                {stat.name}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          {platforms.map((platform, index) => (
            <motion.div
              key={platform.name}
              className="bg-white dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-zinc-800 p-4 hover:shadow-md transition-all duration-300"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-zinc-50 font-outfit">
                      {platform.name}
                    </h3>
                    <span
              ...
              <p className="text-gray-600 dark:text-zinc-400 font-inter text-sm mb-3">
                {platform.description}
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <h4 className="text-sm font-medium text-gray-900 dark:text-zinc-50 mb-2 font-outfit">
                    Key Features:
                  </h4>
                  <ul className="space-y-1">
                    {platform.features.slice(0, 3).map((feature, idx) => (
                      <li
                        key={idx}
                        className="flex items-center space-x-2 text-xs text-gray-600 dark:text-zinc-400"
                      >
              ...
              {platform.status === "coming_soon" && (
                <button className="w-full bg-gray-100 text-gray-600 dark:text-zinc-400 py-2 rounded-lg font-medium text-sm cursor-not-allowed">
                  Coming Soon
                </button>
              )}
            </motion.div>
        ...
        >
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h4 className="text-base font-bold text-gray-900 dark:text-zinc-50 mb-2 font-outfit">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-zinc-400 font-inter mb-2">
